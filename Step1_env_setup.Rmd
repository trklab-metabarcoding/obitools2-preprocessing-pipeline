...
params:
    ...
    seq_dates: 2022-10-13, 2023-05-09
...
output_path <- file.path(here(work_dir, "results"))
merged_path <- file.path(here(output_path, "merged"))
bad_controls_path <- file.path(here(output_path, "bad_control_samples"))
sample_sheet <- read_xlsx(here("sample_sheet.xlsx"), col_types = c("numeric", "text", "text", "text", "text", "text", "text", "text", "text", "date", "date", "date", "text"))
```
...
for (m in seq_along(folders)){
  from = file.path(here("template/data", folders[m]))
