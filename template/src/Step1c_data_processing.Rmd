...
params:
    ...
    project_code: "test"
    sequcing_date: "20221013" # edit this date to match the sequencing date of the run you are working on (i.e. date should match directory label)
...
obistat -c sample *_id.fastq --without-progress-bar | column -t | tee -a ${sequcing_date}_step1c_sample_readcount.txt
```
