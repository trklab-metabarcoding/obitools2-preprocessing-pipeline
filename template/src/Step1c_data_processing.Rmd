...
```
Now navigate to the notebook `Step3a_data_cleaning.Rmd` in the `obitools2-taxonomy-assignment` [repository](https://github.com/trklab-metabarcoding/obitools2-taxonomy-assignment). Use the Files pane in RStudio to navigate to `/oscar/data/tkartzin/r'params$user'.