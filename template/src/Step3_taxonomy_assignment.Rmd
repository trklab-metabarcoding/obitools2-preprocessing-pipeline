...
```{r}
DATE<-"YYYY-MM-DD" #edit YYYY-MM-DD to match the analysis folder name that was created when running step2
FILE_NAME<-"YYYYMMDD_alluniq.clean.fasta" #edit the YYYYMMDD to match the date of the file you created at the end of step2 in the "merged_path" directory.
...
obicount ${DATE}_alluniq.clean.tag.fasta
```
...
obicount -a ${DATE}_alluniq.clean.tag.ann.fasta
```
