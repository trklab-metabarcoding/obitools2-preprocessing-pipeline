...
here::i_am("Step3_taxonomy_assignment.Rmd")
```
...
DATE<- str_extract(DATETIME, "[^_]+") #edit DATETIME to match the analysis folder name that was created when running step2, if not still saved in your R environmnet
